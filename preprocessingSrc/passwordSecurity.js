...
fs.writeFileSync(__dirname + `/../files/passwordSecurity.csv`, `password,predict,label\n`, 'utf8');
...
async function passwordValidation() {
    for (let i = 0; i < testData.length; i++) {
        ...
        fs.appendFileSync(__dirname + `/../files/passwordSecurity.csv`, `${testString[i]},${predictPoint},${testLabel[i]}\n`, 'utf8');
    }
}
