...
async function main() {
    fs.writeFileSync('./unit5Report2.txt', '', 'utf8');
                    ...
                    await new Promise((resolve) => {
                        ...
                        model.fit(trainDataTensor, trainLabelTensor, fitParam).then(async function (result) {
                            for (let his = 0; his < history.length; his++) {
                                fs.appendFileSync('./unit5Report2.txt', 'epoch: ' + his + ', loss: ' + history[his].loss + '\n', 'utf8');
                            }
                            ...
                            for (let checkPoint = 0; checkPoint < checkPoints.length; checkPoint++) {
                                ...
                                fs.appendFileSync('./unit5Report2.txt', checkPoints[checkPoint] + ' : ' + good + ', ' + noGood + '\n', 'utf8');
                            ...
                            model.save(`file://../models/${nodes[node]}_[${units[unit]}]`).then(async function () {
                                ...
                                fs.appendFileSync('./unit5Report2.txt', '====================\n', 'utf8');
                                resolve();
                            });
                        });
                    });
